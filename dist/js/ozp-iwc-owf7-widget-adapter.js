...
ozpIwc.owf7.participantModules.Eventing = (function(){
    /**
     ...
     * @constructor
     */
    var Eventing = function(participant){
        if(!participant) { throw "Needs to have an OWF7Participant";}
        /**
         * @property participant
         * @type {ozpIwc.owf7.Participant}
     ...
     * @returns {String}
     */
    Eventing.pubsubChannel=function(channel) {
     ...
     * @param {String} message
     */
    Eventing.prototype.onContainerInit=function(sender,message) {
     ...
     * @param {String} dest
     */
    Eventing.prototype.onPubsub = function(command,channel,message,dest,sender){
        switch (command) {
            case 'publish':
     ...
     * @param {String} dest
     */
    Eventing.prototype.onPublish=function(command, channel, message, dest, sender) {
        if(this.participant.dd["hookPublish"+channel] && !this.participant.dd["hookPublish"+channel].call(this.participant.dd,message)) {
            return;
        }
        this.dataApi.set(Eventing.pubsubChannel(channel),{
            "entity": {
                "message": message,
                "sender": sender
            },
     ...
     * @param {String} dest
     */
    Eventing.prototype.onSubscribe=function(command, channel, message, dest) {
        this.subscriptions[channel]=this.subscriptions[channel] || {};

        var self = this;

        this.dataApi.watch(Eventing.pubsubChannel(channel),{"lifespan": "ephemeral"},
     ...
     * @param {String} dest
     */
    Eventing.prototype.onUnsubscribe=function(command, channel, message, dest) {
        this.subscriptions[channel] = this.subscriptions[channel] || [];
...
ozpIwc.owf7.participantModules.Kernel = (function () {
    /**
     ...
     * @constructor
     */
    var Kernel = function (participant) {
        if (!participant) {
            throw "Needs to have an Owf7Participant";
        }
     ...
     * @type {String}
     */
    Kernel.prototype.listWidgetChannel = "/owf-legacy/kernel/_list_widgets";
     ...
     * @type {String}
     */
    Kernel.prototype.widgetProxyChannelPrefix = "/owf-legacy/kernel/proxy/";
     ...
     * @returns {String}
     */
    Kernel.prototype.widgetReadyResource = function (widgetId) {
     ...
     * @returns {String}
     */
    Kernel.prototype.functionCallResource = function (widgetId) {
     ...
     * @returns {String}
     */
    Kernel.prototype.functionCallResultResource = function (widgetId) {
     ...
     * @returns {String}
     */
    Kernel.prototype.directMessageResource = function (widgetId) {
     ...
     * @returns {String}
     */
    Kernel.prototype.callEventResource = function (eventName) {
     ...
     * @returns {String}
     */
    Kernel.prototype.registerWidgetReadyListener = function () {
        var self = this;
     ...
     */
    Kernel.prototype.registerWidgetListing = function () {
        var self = this;
     ...
     */
    Kernel.prototype.unregisterWidgetListing = function () {
     ...
     * @param {Object} rpc
     */
    Kernel.prototype.onGetWidgetReady = function (widgetId, rpc) {
     ...
     * @param {String} widgetId
     */
    Kernel.prototype.onWidgetReady = function (widgetId) {
     ...
     * @param {String[]} functions
     */
    Kernel.prototype.onRegisterFunctions = function (iframeId, functions) {
     ...
     * @param {Object} rpc
     */
    Kernel.prototype.onGetFunctions = function (widgetId, sourceWidgetId, rpc) {
        var self = this;
        this.dataApi.get(this.widgetProxyChannelPrefix + widgetId).then(function (reply) {
     ...
     * @param {Array} var_args
     */
    Kernel.prototype.onFunctionCall = function (widgetId, widgetIdCaller, functionName, var_args) {
    ...
    /**
     * When receiving a function call from another widget, this calls rpc FUNCTION_CALL_CLIENT to route it to this
     * legacy widget.
     ...
     * @param {Array} var_args
     */
    Kernel.prototype.functionCallClient = function (widgetId, widgetIdCaller, functionName, var_args) {
        gadgets.rpc.call(this.participant.rpcId, 'FUNCTION_CALL_CLIENT', null, widgetId, widgetIdCaller, functionName, var_args);
    };

    /**
     *  When receiving a function call result from another widget, this calls rpc  FUNCTION_CALL_CLIENT to route it to
     * this legacy widget.
     ...
     * @param {String} result
     */
    Kernel.prototype.functionCallResultClient = function (widgetId, widgetIdCaller, functionName, result) {
     ...
     * @param {Object} result
     */
    Kernel.prototype.onFunctionCallResult = function (widgetId, widgetIdCaller, functionName, result) {
     ...
     */
    Kernel.prototype.registerFunctionCallListener = function () {
        var self = this;
     ...
     * @method registerFunctionCallHandler
     */
    Kernel.prototype.registerFunctionCallResultListener = function () {
        var self = this;
     ...
     * @param {Object} rpc
     */
    Kernel.prototype.onListWidgets = function (rpc) {
        var self = this;
     ...
     */
    Kernel.prototype.onDirectMessage = function (widgetId, dataToSend) {
     ...
     */
    Kernel.prototype.registerDirectMessageListener = function () {
        var self = this;
    ...
    /**
     *  When receiving a direct message from another widget, this calls DIRECT_MESSAGE to route it to this legacy
     * widget.
     * @method directMessageClient
     * @param {*} payload
     */
    Kernel.prototype.directMessageClient = function (payload) {
        gadgets.rpc.call(this.participant.rpcId, 'DIRECT_MESSAGEL_CLIENT', null, payload);
    };

    /**
     *  When receiving a add event call from the widget, this registers to pass any events onto the widget for the
     * eventName.
     * @method onAddEvent
     * @param {String} widgetId
     * @param {String} eventName
     */
    Kernel.prototype.onAddEvent = function (widgetId, eventName) {
        var self = this;
     ...
     * @param {*} payload
     */
    Kernel.prototype.eventClient = function (eventName, payload) {
     ...
     * @param {*} payload
     */
    Kernel.prototype.onCallEvent = function (eventName, payload) {
